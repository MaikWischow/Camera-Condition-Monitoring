...
# Modified by MaikWischow, 2021.10.14
...
def createDataset(dirInOut, resultFileNameOut):
    ...
    if os.path.exists(dirInOut):
        dc = DatabaseCreator(dirInOut, os.path.join(dirInOut, resultFileNameOut), \
                             inImageType=DatabaseCreator.IM_RGB, outImageType=DatabaseCreator.IM_RGB, 
...
#     dirTestImgs = r".\test" # Directory not included in this repository.
#     dirTrainImgs = r".\train" # Directory not included in this repository.
